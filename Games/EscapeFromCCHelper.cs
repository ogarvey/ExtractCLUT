...
namespace ExtractCLUT.Games
{
    ...
    {
        static string _DyuvPath = @"C:\Dev\Projects\Gaming\CD-i\Escape From CyberCity (R)\records\CCStart1\video\CCStart1_v_1_0_DYUV_Normal_3.bin";
        static string _outputPath = @"C:\Dev\Projects\Gaming\CD-i\Escape From CyberCity (R)\records\CCStart1\video\output\";
